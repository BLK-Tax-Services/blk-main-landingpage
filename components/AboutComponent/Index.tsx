        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              <span className="mb-4 mr-4 inline-flex rounded-full border border-1 border-meta px-4.5 py-1 text-metatitle  text-meta ">
                About Us
              </span>
          ...
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            ...
            <div className=" md:w-1/2">
              ...
              <p>
                ...
                by simplifying the tax process, ensuring compliance,
                and maximizing returns. We focus on building lasting
